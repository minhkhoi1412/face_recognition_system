...
MODEL_PATH = r'C:\KhoiNXM\Workspace\Learning\Master Thesis\Dev\face_recognition_system\models\facenet'
...
def load_faceslist():
    embeds = torch.load(f'{MODEL_PATH}/faceslist.pth')
    names = np.load(f'{MODEL_PATH}/usernames.npy')
    return embeds, names
